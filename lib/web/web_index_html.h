 ...
 * @LastEditTime: 2023-08-21 18:03:22
 */
...
<el-form-item label="RGB灯效样式" v-if="form.rgbOpen"><el-radio-group v-model="form.rgbStyle"><el-radio :label="1">线性循环</el-radio>
...
<el-form-item label="滚动文字"><el-input maxlength="48" show-word-limit v-model="form.customLongText" placeholder="请输入文字" autosize clearable></el-input></el-form-item>
