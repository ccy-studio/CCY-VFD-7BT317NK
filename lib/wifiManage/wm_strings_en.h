...
"<form action='/wifi'    method='get'><button>WIFI配置</button></form><br/>\n", // MENU_WIFI
"<form action='/0wifi'   method='get'><button>Configure WiFi (No scan)</button></form><br/>\n", // MENU_WIFINOSCAN
"<form action='/info'    method='get'><button>系统信息</button></form><br/>\n", // MENU_INFO
"<form action='/param'   method='get'><button>装载</button></form><br/>\n",//MENU_PARAM
...
"<form action='/erase'   method='get'><button class='D'>清空配置</button></form><br/>\n", // MENU_ERASE
...
const char HTTP_FORM_WIFI[]        PROGMEM = "<label for='s'>WIFI名</label><input id='s' name='s' maxlength='32' autocorrect='off' autocapitalize='none' placeholder='{v}'><br/><label for='p'>WIFI密码</label><input id='p' name='p' maxlength='64' type='password' placeholder='{p}'><input type='checkbox' onclick='f()'> 显示密码";
...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>正在保存凭据<br/>正在尝试将ESP连接到网络.<br />如果失败，请重新连接到AP重试</div>";
...
const char HTTP_STATUS_ON[]        PROGMEM = "<div class='msg S'><strong>已连接</strong> to {v}<br/><em><small>with IP {i}</small></em></div>";
const char HTTP_STATUS_OFF[]       PROGMEM = "<div class='msg {c}'><strong>没有连接</strong> to {v}{r}</div>"; // {c=class} {v=ssid} {r=status_off}
const char HTTP_STATUS_OFFPW[]     PROGMEM = "<br/>身份认证失败"; // STATION_WRONG_PASSWORD,  no eps32
...
const char S_titlewifisettings[]  PROGMEM = "已保存设置";
...
const char S_closing[]            PROGMEM = "您可以关闭页面,portal将继续运行";
const char S_error[]              PROGMEM = "出现错误";
